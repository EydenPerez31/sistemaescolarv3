...
->get();
$promedio = BD::table('calificaciones')->avg('calificacion');
    ...
    <tr>
        ...
        <td>
            <form action="ubdate.php" method="post">
             <input id="calificacion" type="text" name="idcalificacion"
             value="{$fila->idcalificacion}" hidden>
             <input id="calificacion" type="text" name="idcalificacion" size="3">
